...
Name: Bunyodbek Ibrokhimov
ID:   22182246

Face emotions recognition project using fer2013.csv European face emotion recognition dataset and Korean face emotion recognition dataset.
'''
...
#'''
#--------------------------------Load Korean face dataset
#converting gray images and reshaping into 48x48
print('Loading Korean face dataset...')
cv_img = []
...
for file in filenames:
	...
	cv_img.append(img)
images = np.array(list(cv_img), np.float32)
images = images.reshape(images.shape[0],48,48,1)
images /= 255
#'''

#loading labels for korean data
k_data = pd.read_csv('korean_face_dataset_22182246.csv')
k_pred = model2.predict_classes(images)
print('\nk_pred count: ', collections.Counter(k_pred))
y_class = k_data['Emotion']

#evaluating on k_data
print('Done.\nAccuracy: %f' % accuracy_score(y_class, k_pred))
